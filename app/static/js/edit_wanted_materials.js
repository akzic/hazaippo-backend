// app/static/js/edit_wanted_material.js

document.addEventListener("DOMContentLoaded", function() {
    const materialType = document.getElementById("material_type");
    const woodTypeGroup = document.getElementById("wood_type_group_wanted");
    const plasterboardTypeGroup = document.getElementById("board_material_type_group_wanted");
    const panelTypeGroup = document.getElementById("panel_type_group_wanted");
    ...
    // 以下のコードは既存の機能に基づくものであり、マップ関連のコードを削除しています。
